...
if (isset($_POST['uname'])) {
  ...
  $MM_redirectLoginSuccess = "http://localhost/index.php/EditeInfo.php";
...
<section class="container">
     <div class="login">
      ...
      <form action="<?php echo $loginFormAction; ?>" method="POST" id="form1">
        ...
        <p><input type="password" name="pword" value="" placeholder="Password" id="pword"></p>
        <p class="remember_me">
          <label>
  ...
  <section class="about">
    ...
    <p class="about-author">
      &copy; 2013&ndash;2014 <a href="http://thibaut.me" target="_blank">Wat Chedi Luang</a>
