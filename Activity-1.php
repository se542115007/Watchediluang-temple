        ...
        <div class="zerogrid">
            <div class="wrapper">
            	<div class="row content-bg">
                	<div class="wrapper">
                    	<article class="col-4-8">
							<div class="wrap-col">
                        	<h2></h2>
                            <table>
                           <td style="border:2px"><?php
$res = mysql_query("Select * from attraction where id=3");
	while ($row = mysql_fetch_array($res)) {
	echo "<h2>".$row["name"]."</h2>"; echo("<br>");
	echo "<h6>". $row["description"]."</h6>"; echo("<br>");
    
	}
mysql_close();

?></td>
<td><iframe src="https://www.google.com/calendar/embed?src=reg.cmu%40gmail.com&ctz=Asia/Bangkok" style="border: 0" width="340" height="320" frameborder="0" scrolling="no"></iframe>
</td>
</table>
